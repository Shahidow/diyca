...
class LoginInteractorImpl(
    ...
    override suspend fun login(loginData: LoginData): Resource<UserData> {
        ...
        return coroutineScope {
            ...
            /*
            val rewardsDeferred = async { userNetworkRepository.getRewards() }
            */
            ...
            */
            ...
            when {
                ...
                */
                    ...
                    progressData.forEach { progress -> userDataBaseRepository.insertUserProgress(progress) }
                    val activityData = (activityRes as Resource.Success).data ?: emptyList()
                    activityData.forEach { activity -> userDataBaseRepository.insertActivity(activity) }
                    /*
                    userDataBaseRepository.saveRewards((rewardsRes as Resource.Success).data!!)
                    */
                    loginResource
                }
            }
